...
self.addEventListener('fetch', event => {
  ...
  if (url.hostname.includes('gnews.io') || url.hostname.includes('newsapi.org')) {
    event.respondWith(
      fetch(request).catch(() =>
...
self.addEventListener('push', event => {
  ...
  self.registration.showNotification(data.title || 'Pulse News', {
